...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { assign_date: @phone.assign_date, is_assign: @phone.is_assign, ph_number: @phone.ph_number } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { assign_date: @phone.assign_date, is_assign: @phone.is_assign, ph_number: @phone.ph_number } }
